...
function fadeSlideShow(settingarg){
	...
	setting.closebutton=(setting.descreveal=="always")? '<img class="close" src="../../content/js/'+closebutt[0]+'" style="float:right;cursor:hand;cursor:pointer;width:'+closebutt[1]+'px;height:'+closebutt[2]+'px;margin-left:2px" title="Hide Description" />' : ''
	var slideshow=this
	jQuery(document).ready(function($){ //fire on DOM ready
		...
		var $loadingimg=$('<img src="../../content/js/'+fadeSlideShow_descpanel.controls[2][0]+'" style="position:absolute;width:'+fadeSlideShow_descpanel.controls[2][1]+';height:'+fadeSlideShow_descpanel.controls[2][2]+'" />')
...
fadeSlideShow.routines={
	...
	getSlideHTML:function(imgelement){
		var layerHTML=(imgelement[1])? '<a href="../../content/js/'+imgelement[1]+'" target="'+imgelement[2]+'">\n' : '' //hyperlink slide?
		layerHTML+='<img src="../../content/js/'+imgelement[0]+'" style="border-width:0;" />\n'
	...
	adddescpanel:function($, setting){
		...
		if (setting.descreveal=="always"){ //create restore button
			setting.$restorebutton=$('<img class="restore" title="Restore Description" src="../../content/js/' + fadeSlideShow_descpanel.controls[1][0] +'" style="position:absolute;visibility:hidden;right:0;bottom:0;z-index:1002;width:'+fadeSlideShow_descpanel.controls[1][1]+'px;height:'+fadeSlideShow_descpanel.controls[1][2]+'px;cursor:pointer;cursor:hand" />')
				.appendTo(setting.$wrapperdiv)
